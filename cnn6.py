...
#am trecut de la antrenare pe cpu la antrenare pe gpu pentru a creste viteza
...
weights = torch.tensor([1 / c for c in class_counts], dtype=torch.float).to(device)
...
torch.save(best_model, "best_model6.pth")
...
plt.legend()
plt.savefig("training_curve6.png")
